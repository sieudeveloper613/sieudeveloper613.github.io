...
import RestaurantStatisticalReportsPage from '../../../components/pages/resources/StatisticalReports/agricultural-produce/RestaurantStatisticalReportsPage';
...
const children: TNavigateItemConfig[] = [
    ...
    },
    {
        ...
        PageComponent: RestaurantStatisticalReportsPage,
    },
];
