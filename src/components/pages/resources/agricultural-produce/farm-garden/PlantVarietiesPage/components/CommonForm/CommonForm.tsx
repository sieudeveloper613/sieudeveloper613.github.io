                ...
                <div className={styles['container']}>
                    <div className={styles['input-wrap']}>
                        <TextField
                            ...
                            markIsRequired={!Boolean(idUpdate)}
                            title={`Loại ${Self.title.toLowerCase()}`}
                    ...
                    <div className={styles['input-wrap']}>
                        <TextField
                            ...
                            markIsRequired={!Boolean(idUpdate)}
                            title={`Loại sản phẩm`}
                            validator={Self.validator.agricultureProduceName}
                            invalidMessage='Mục này không được để trống'
                            value={inputAgricultureProduceName}
                            readonly={Boolean(idUpdate)}
                            nonButton={1}
                            //
                            onChange={setInputAgricultureProduceName}
                        />
                    </div>
