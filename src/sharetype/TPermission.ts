...
export enum ETypeUser {//**
    ...
    customerProducts = 'customer-products', //sản phẩm tiêu dùng
    shippingService = 'shipping-service', // dịch vụ vận chuyển
    medicine = 'medicine', // dược
    MeatProduce = 'MeatProduce', //Thịt
    fisheries = 'fisheries', //thủy sản
    molluscs = 'molluscs', //Nhuyễn thể,
    other='orther' // Các đối tượng khác
}
type TMakeType<Type> = Type
type TTypeUser = TMakeType<ETypeUser>
export type TTypeUserRole = TTypeUser | 'undefined'
...
export enum EnterpriseRole { //**
    ...
    dealerStore = 'dealerStore', // bán lẻ **
    supermarket = 'supermarket', //**
    restaurant = 'restaurant', //**
    enterprise = 'enterprise', // Doanh nghiệp //**  
}
...
type TPermission =
    ...
    | TMakePermission<EResource.enterprise, EnterpriseRole>
